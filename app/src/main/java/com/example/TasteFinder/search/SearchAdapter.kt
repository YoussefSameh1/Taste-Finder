...
class SearchAdapter (private var restaurants:List<Restaurant>, private val listener: OnRestaurantClickListener):
    RecyclerView.Adapter<SearchAdapter.SearchViewHolder>() {

        class SearchViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView){
            val restaurantName: TextView = itemView.findViewById(R.id.search_name)
            val restaurantImage: ImageView = itemView.findViewById(R.id.search_image)
